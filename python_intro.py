...
# int = 645644564   <-- Don't redefine protected words!!!
# print(int('5'))
...
# concatenation  + interpolation (f-string and maybe don't to remember this term exactly)
...
#syntax -->   function(arguements)   vs datatype.method(arguements)
...
# .pop()
# removes an item from the list by position, defaults to the last.  returns the value so you could save it to a variable. .. 
a_list.pop()
print(a_list)
print(a_list.pop(0))
print(a_list)
...
names = ['Stephen', 'Jeni', 'Gianni', 'Heather', 'Eddie']
...
#Functions
# definiton vs calling the function
def hello(name):
